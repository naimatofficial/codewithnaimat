...
const PostDetail = ({ post }) => {
      ...
      case 'bulleted-list':
        return (
          <ul key={index} className="ml-2 mb-4">
            <li className="tex-md mb-1 font-semibold">
              {modifiedText.map((item, i) => (
                <React.Fragment key={i}>{item}</React.Fragment>
              ))}
            </li>
  ...
  return (
    <div className="mb-8 rounded-lg bg-white pb-12 shadow-lg lg:p-8">
      <div className="realtive mb-6 overflow-hidden shadow-md">
        <img
      ...
      <div className="px-4 lg:px-0">
        <div className="mb-8 flex w-full items-center">
          <div className="mb-3 mr-8 flex w-full items-center lg:mb-0 lg:w-auto">
            <img
        ...
        <h1 className="mb-8 text-3xl font-semibold text-pink-600">
          {post.title}
        </h1>
